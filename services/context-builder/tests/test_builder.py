...
SKILL_RESPONSES: dict[str, tuple[int, Any]] = {
    ...
    "/api/v1/courses/C1/assignments/A1/submissions/U1": (200, {"user_id": "U1", "score": 92}),
}
...
def test_failed_fetch_becomes_error_object_in_bundle(profiles, fake_client):
    responses = dict(SKILL_RESPONSES)
    responses["/api/v1/courses/C1/assignments/A1/submissions/U1"] = (
        404,
...
def test_course_completed_happy_path(profiles, fake_client):
    ...
    responses: dict[str, tuple[int, Any]] = {
        ...
        "/api/v1/courses/C1/modules?include[]=items": (200, []),
        "/api/v1/courses/C1/pages": (200, []),
        "/api/v1/courses/C1/assignments": (200, []),
