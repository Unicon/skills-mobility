...
class Outcome(BaseModel):
    ...
    display_name: str = ""
    description: str = ""
    # Flat Canvas outcome code, e.g. "1" (competency) or "1.2.3" (sub-competency).
    code: str = ""
    # Explicit competency flag (design open question: convention vs field — POC
    # uses an explicit field for clarity).
