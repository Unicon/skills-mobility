...
def build_user_message(request: MappingRequest, target_schema: dict[str, Any]) -> str:
    """Assemble the user message: the mapping task, the target schema, and the
    supplied source payloads (already screened by the caller)."""
    task = {
