...
| 3 | Embeddings/re-ranker hybrid for Field Mapping | A second, cheaper, more debuggable path to Field Mapping as a hedge if the pure-LLM approach underperforms | High — a second implementation path competing for the same runway as the first |
